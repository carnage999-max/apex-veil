        ...
        <section id="contact" className="py-24 bg-black border-t border-steel/20 relative overflow-hidden">
            <div className="container mx-auto px-4 flex flex-col items-center text-center">
                <div className="max-w-xl w-full">
                    ...
                    <div className="grid grid-cols-1 gap-12 mb-16">
                        ...
                        <div>
                            ...
                            <div className="flex gap-4 justify-center">
                                <a href="#" className="p-3 border border-zinc-800 hover:border-secondary text-zinc-100 hover:text-white transition-all transform hover:-translate-y-1">
                                    <Youtube className="w-5 h-5" />
                                </a>
                                <a href="#" className="p-3 border border-zinc-800 hover:border-secondary text-zinc-100 hover:text-white transition-all transform hover:-translate-y-1 group">
                    ...
                    <div className="mt-8 pt-8 border-t border-zinc-900 text-zinc-200 text-[10px] uppercase tracking-[0.2em]">
